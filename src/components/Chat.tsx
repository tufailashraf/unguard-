...
function Chat() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Chat Button */}
      <button
        onClick={() => setShowPaperGen(true)}
        className="fixed bottom-8 right-8 flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-colors z-50"
